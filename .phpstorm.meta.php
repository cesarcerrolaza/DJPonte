...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\www\djponte\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\www\\djponte\\public\\storage','fortify.guard',
...
'hashing.rehash_on_login','view.paths','view.compiled','cashier.key','cashier.secret',
...
'livewire.preview-file','instagram.webhook','stripe.webhook',
'welcome','loader','djsessions.exit','dashboard','djsessions.index',
'djsessions.search','home','tip.id','djsessions.join','djsessions.leave',
'song-request','tip','raffle','tips.success','tips.cancel',
'djsessions.create','djsessions.store','djsessions.show','djsessions.edit','djsessions.update',
'djsessions.destroy','instagram.connect','instagram.callback','tiktok.connect',
'storage.local',);
...
'components.danger-button','components.dialog-modal','components.disabled-button','components.djsession-card','components.dropdown',
'components.dropdown-button','components.dropdown-link','components.form-section','components.input','components.input-error',
'components.label','components.landing-options','components.loader','components.login','components.modal',
'components.nav-link','components.register','components.request-timeout','components.responsive-nav-link','components.roulette-dj',
'components.roulette-user','components.secondary-button','components.section-border','components.section-title','components.switchable-team',
'components.tab-button','components.tip-item','components.tooltip','components.trophy-icon','components.validation-errors',
'components.welcome','dashboard','djsessions.create','djsessions.edit','djsessions.index',
'djsessions.search','djsessions.show','emails.team-invitation','home','layouts.app',
'layouts.guest','layouts.landing','layouts.partials_.header','layouts.partials_.sidebar','livewire.djsession-card',
'livewire.djsession-manager','livewire.djsession-summary','livewire.donors.donor-form-view','livewire.donors.donor-management-view','livewire.donors.donor-summary-view',
'livewire.raffles.raffle-entry-form','livewire.raffles.raffle-info-form','livewire.raffles.raffle-info-management','livewire.raffles.raffle-info-summary','livewire.raffles.raffle-manager-form',
'livewire.raffles.raffles-management','livewire.songs.song-request-form','livewire.songs.song-requests','livewire.tips.tip-form','livewire.tips.tip-list',
'loader','navigation-menu','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form',
...
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.www.djponte.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'LOG_LEVEL','APP_DEBUG','DB_CONNECTION','DB_HOST','DB_PORT',
...
'MAIL_FROM_NAME','META_VERIFY_TOKEN','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME','STRIPE_KEY',
'STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT',
'VITE_REVERB_SCHEME',);
