<div 
    @if($role == 'dj')
        class="flex items-center justify-between bg-white p-4 rounded-lg shadow-md w-full max-w-5xl mx-auto hover:bg-gray-50 cursor-pointer"
        onclick="window.location='{{ route('djsessions.show', $djsession) }}'"
        style="cursor: pointer;"
    @else
        class="flex items-center justify-between bg-white p-4 rounded-lg shadow-md w-full max-w-5xl mx-auto"
    @endif
        >
    <!-- Imagen del local -->
